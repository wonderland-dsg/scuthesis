...
这是 \scuthesis\cite{scuthesis} 的示例文档，基本上覆盖了模板中所有格式的设置。建
议大家在使用模板之前，除了阅读《\scuthesis{} 用户手册》，这个示例文档也最好能看一
看。
...
{\ifcsname youyuan\endcsname\youyuan\else[无 \cs{youyuan} 字体。]\fi 幼圆}

{\heiti 黑体}

{\ifcsname lishu\endcsname\lishu\else[无 \cs{lishu} 字体。]\fi 隶书}
...
\begin{table}[htb]
  ...
  \label{tab:template-files}
    \begin{tabularx}{\linewidth}{lX}
      ...
      scuthesis.cls & 模板类文件。\\
      scuthesis-numeric.bst    & 参考文献 BibTeX 样式文件。\\
      scuthesis-author-year.bst    & 参考文献 BibTeX 样式文件。\\
...
\begin{table}[htbp]
  ...
  \begin{minipage}[t]{0.8\textwidth}
    ...
    \end{tabularx}\\[2pt]
    \footnotesize 注：数据来源《\scuthesis{} 使用手册》。\\
    *：东部\\
    **：西部
  \end{minipage}
\end{table}
...
\begin{table}[htbp]
  ...
  \begin{tabular}[c]{|m{1.5cm}|c|c|c|c|c|c|}\hline
    ...
    \multirow{2}{1.5cm}{Xue} & Rui  & Ni &\multicolumn{4}{c|}{\multirow{2}*{\scuthesis}}\\\cline{2-3}
